...
public class Parser {
    ...
    private static ic.ast.Node constructProgAst(fun.parser.Tree parseTree) {
        return ProgParser.Parse(parseTree);
    }
	...
	public static ic.ast.Node processProgram(Iterable<Token> tokens) {
		return constructProgAst(parseProgram(tokens));
	}
